package com.inool.daijia.payment.service.impl;
...
import com.inool.daijia.model.entity.payment.ProfitsharingInfo;
import com.inool.daijia.model.form.payment.ProfitsharingForm;
import com.inool.daijia.payment.config.WxPayV3Properties;
import com.inool.daijia.payment.mapper.PaymentInfoMapper;
import com.inool.daijia.payment.mapper.ProfitsharingInfoMapper;
...
public class WxProfitsharingServiceImpl implements WxProfitsharingService {
    ...
    public void profitsharing(ProfitsharingForm profitsharingForm) {
        ...
        if(ordersEntity.getState().name().equals("FINISHED")) {
            ...
            log.error("执行分账失败");
            throw new InoolException(ResultCodeEnum.PROFITSHARING_FAIL);
        }
    }
}
